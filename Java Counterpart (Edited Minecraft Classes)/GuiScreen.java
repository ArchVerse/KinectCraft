...
public class GuiScreen extends Gui
{
    ...
    public static boolean shiftingIt = false;
    ...
    public void initGui() {
        ...
        this.mc.socks.messageCallbacks.add(new NewMessage(){
        	...
        	public void sendMessage(String message)
        	{
    			...
    			{
    				if(instructions[i].compareTo("click_left") == 0)
    				{
    					mouseClicked(var1, var2, 0);
    				}
    				if(instructions[i].compareTo("click_right") == 0)
    				{
    					mouseClicked(var1, var2, 1);
    				}
    				if(instructions[i].compareTo("shift") == 0)
    				{
    					shiftingIt = true;
    				}
    				if(instructions[i].compareTo("!shift") == 0)
    ...
    {
        return Keyboard.isKeyDown(42) || Keyboard.isKeyDown(54) || shiftingIt;
    }
}
